...
export function ResultsTable({
  ...
  return (
    <table className="min-w-full border-collapse text-left font-(--font-mono) text-xs leading-5">
      <thead className="sticky top-0 z-10 bg-(--app-surface-raised) text-xs uppercase tracking-[0.08em] text-(--app-text)">
        {/* */}

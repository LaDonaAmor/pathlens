...
export const toolbarLabelClass =
  "inline-flex h-10 cursor-pointer items-center justify-center gap-2 rounded-none border-2 border-(--app-border) bg-(--app-surface) px-4 font-(--font-mono) uppercase tracking-widest text-(--app-text) transition hover:-translate-x-0.5 hover:-translate-y-0.5 hover:bg-(--app-accent) hover:text-(--app-on-accent) active:translate-x-0 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-50 !text-xs"
